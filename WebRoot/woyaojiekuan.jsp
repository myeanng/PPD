...
<html>
  <head>
    ...
    <script src="woyaojiekuan_files/a" async="" charset="utf-8" type="text/javascript"></script>
    <script src="woyaojiekuan_files/crmqq.php" async="" charset="utf-8" type="text/javascript"></script>
    <script src="woyaojiekuan_files/contains.js" async="" charset="utf-8" type="text/javascript"></script>
    <script src="woyaojiekuan_files/localStorage.js" async="" charset="utf-8" type="text/javascript"></script>
    <script src="woyaojiekuan_files/Panel.js" async="" charset="utf-8" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="woyaojiekuan_files/basic.css">
    <link rel="stylesheet" type="text/css" href="woyaojiekuan_files/layout.css">
    <link href="woyaojiekuan_files/validation-min.css" rel="stylesheet">
    <link rel="shortcut icon" href="http://www.ppdaicdn.com/favicon.ico" type="image/x-icon">
    <script src="woyaojiekuan_files/v.htm" charset="utf-8"></script><script src="woyaojiekuan_files/hm.js"></script><script src="woyaojiekuan_files/analytics.js" async=""></script><script src="woyaojiekuan_files/gtm.js" async=""></script><script src="woyaojiekuan_files/newRefer.js"></script>
    ...
    </script><script src="woyaojiekuan_files/h.js" type="text/javascript"></script>
    
    <link href="woyaojiekuan_files/bindAccount.css" rel="stylesheet">

<script src="woyaojiekuan_files/jquery_002.js" type="text/javascript"></script><script src="woyaojiekuan_files/ppd_pop.js" type="text/javascript"></script><script src="woyaojiekuan_files/hubs" type="text/javascript"></script><script src="woyaojiekuan_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner w1000center clearfix">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="woyaojiekuan_files/logo.png" alt=""></a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
                    ...
                    <div class="product_nav">
                        <div class="product left">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <a title="查看该产品的详细说明" href="putongjiekuanjieshao.jsp" target="_blank">查看该产品的详细说明</a>
                                </div>
                                <input class="btn font_yahei" onclick="borrowRedirect('userinfo/checkUserinfo','/createlist1')" value="立即申请" type="button">
                            </div>
                        </div>
                        <div class="product center">
                            ...
                            <div class="content">
                                ...
                                <div style="margin-top:30px;"><a title="查看该产品的详细说明" href="putongjiekuanjieshao.jsp" target="_blank">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" onclick="borrowRedirect('userinfo/checkUserinfo', '/createlist1')" value="立即申请" type="button">
                            </div>
                        </div>
                        <div class="product right">
                            ...
                            <div class="content">
                                ...
                                <div><a title="查看该产品的详细说明" href="putongjiekuanjieshao.jsp" target="_blank">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" onclick="borrowRedirect('userinfo/checkUserinfo', '/createlist1')" value="立即申请" type="button">
                            </div>
                        </div>
                        ...
                        <div class="product left02">
                            ...
                            <div class="content">
                                ...
                                <div><a title="查看该产品的详细说明" href="putongjiekuanjieshao.jsp" target="_blank" style="margin-top: 80px;">查看该产品的详细说明</a></div>
                        ...
                        <div class="product center02">
                            ...
                            <div class="content">
                                ...
                                <div style="margin-top:60px;"><a title="查看该产品的详细说明" href="putongjiekuanjieshao.jsp" target="_blank" style="margin-top: 80px;">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" onclick="borrowRedirect('userinfo/checkUserinfo', '/createlist1')" value="立即申请" type="button">
                            </div>
                        </div>
...
司</p>
    ...
    <script src="woyaojiekuan_files/jquery.js" type="text/javascript" charset="utf-8"></script>
    <script src="woyaojiekuan_files/init.js" type="text/javascript" charset="utf-8"></script>
    <script src="woyaojiekuan_files/servicestack-min.js"></script>
    <script src="woyaojiekuan_files/jquery_003.js"></script>
    <script src="woyaojiekuan_files/status" type="text/javascript"></script><script type="text/javascript" src="woyaojiekuan_files/acstatus.js"></script>
    ...
    <script>
        ...
        try {
            ...
            <script src="woyaojiekuan_files/validation.js"></script>
            <script src="woyaojiekuan_files/validation-zh.js"></script>
            <script type="text/javascript" src="woyaojiekuan_files/customize.js"></script>
            <script type="text/javascript">
...
<script src="woyaojiekuan_files/wpa.php" type="text/javascript" charset="utf-8"></script>
