...
<html>
  <head>
    ...
    <title>我要借入_申请发标_拍拍贷</title>
    <meta name="description" content="我要借入,申请发标，拍拍贷-中国领先互联网金融P2P网贷平台 提供网络贷款，投资理财 小额贷款,短期贷款,个人贷款,无抵押贷款服务 拍拍贷理财借贷投资，获得高年收益率回报，超低门槛，超高收益">
    <meta name="keywords" content="我要借入,申请发标">
    <link rel="stylesheet" type="text/css" href="./ppd_borrow_files/basic.css">
    <link rel="stylesheet" type="text/css" href="./ppd_borrow_files/layout.css">
    <link href="./ppd_borrow_files/validation-min.css" rel="stylesheet">
    <link rel="shortcut icon" href="http://www.ppdaicdn.com/favicon.ico" type="image/x-icon">
    <script src="./ppd_borrow_files/v.htm" charset="utf-8"></script><script src="./ppd_borrow_files/hm.js"></script><script src="./ppd_borrow_files/analytics.js" async=""></script><script src="./ppd_borrow_files/gtm.js" async=""></script><script src="./ppd_borrow_files/newRefer.js"></script>
    ...
    </script><script src="./ppd_borrow_files/h.js" type="text/javascript"></script>
    
    <link href="./ppd_borrow_files/bindAccount.css" rel="stylesheet">

<script src="./ppd_borrow_files/jquery_003.js" type="text/javascript"></script><script src="./ppd_borrow_files/ppd_pop.js" type="text/javascript"></script><script src="./ppd_borrow_files/hubs" type="text/javascript"></script><script src="./ppd_borrow_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner w1000center clearfix">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="./ppd_borrow_files/logo.png" alt=""></a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
                ...
                <li class="hasSubMenu">
                    <a class="tabon" href="http://www.ppdai.com/borrow" category="Borrow">我要借款</a>
                    <div class="subMenu">
...
<div>
    <ul class="breadcrumb" style="border: none !important;">
        <li><a href="http://www.ppdai.com/">首页</a> <span class="divider">&gt;</span></li>
            <li><a href="http://www.ppdai.com/borrow">我要借款</a> </li>
            </ul>
</div>
<script>
                    ...
                    <div class="product_nav">
                        <div class="product left">
                            ...
                            <div class="content">
                                ...
                                <div>
                                    <a title="查看该产品的详细说明" href="http://www.ppdai.com/borrow/listtype_pt" target="_blank">查看该产品的详细说明</a>
                                </div>
                                <input class="btn font_yahei" onclick="borrowRedirect('/borrow/createlist/1', '/createlist1')" value="立即申请" type="button">
                            </div>
                        </div>
                        <div class="product center">
                            <h2 class="title tbg2" style="font-weight: normal">网购达人标</h2>
                            <div class="content">
                                <h3>适用网购达人</h3>
                                <p>申请条件</p>
                                <ul>
                                ...
                                <div style="margin-top:30px;"><a title="查看该产品的详细说明" href="http://www.ppdai.com/borrow/listtype_wg" target="_blank">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" onclick="borrowRedirect('/borrow/createlist/4', '/createlist4')" value="立即申请" type="button">
                            </div>
                        </div>
                        <div class="product right">
                            <h2 class="title tbg3" style="font-weight: normal">应收安全标</h2>
                            <div class="content">
                                <h3>适用借出者</h3>
                                <p>申请条件</p>
                                <ul>
                                ...
                                <div><a title="查看该产品的详细说明" href="http://www.ppdai.com/borrow/listtype_ac" target="_blank">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" onclick="borrowRedirect('/borrow/createlist/6', '/createlist6')" value="立即申请" type="button">
                            </div>
                        </div>
                        <div style="clear: both"></div>
                        <div class="product left02">
                            <h2 class="title tbg4" style="font-weight: normal">网商用户标</h2>
                            <div class="content">
                                <h3>适用网店卖家</h3>
                                <p>申请条件</p>
                                <ul>
                                    <li>通过网商认证</li>
                                    <li>网上店铺等级达到5钻可申请借款额度</li>
                                    <li>商城经营时间满半年可申请借款额度</li>
                                </ul>
                                <div><a title="查看该产品的详细说明" href="http://www.ppdai.com/borrow/listtype_ws" target="_blank" style="margin-top: 80px;">查看该产品的详细说明</a></div>
                                <div style="margin-top: 0;">
                                    <input class="btn font_yahei" onclick="javascript: location = '/info/taobaouserdocuments'" value="申请借款额度" type="button"><span class="question" id="question_01"></span>
                                </div>
                                <input class="btn font_yahei" style="margin-top: 16px;" onclick="borrowRedirect('/borrow/createlist/2', '/createlist2')" value="立即申请" type="button">
                            </div>
                        </div>
                        <div class="product center02">
                            <h2 class="title tbg5" style="font-weight: normal">私营企业主标</h2>
                            <div class="content">
                                <h3>适用私营业主</h3>
                                <p>申请条件</p>
                                <ul>
                                ...
                                <div style="margin-top:60px;"><a title="查看该产品的详细说明" href="http://www.ppdai.com/borrow/listtype_sy" target="_blank" style="margin-top: 80px;">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" style="margin-top: 75px;" onclick="borrowRedirect('/borrow/createlist/1', '/createlist1_syyz')" value="立即申请" type="button">

                            </div>
                        </div>
                        <div class="product right02">
                            <h2 class="title tbg6" style="font-weight: normal">莘莘学子标</h2>
                            <div class="content">
                                <h3>适用大学生</h3>
                                <p>申请条件</p>
                                <ul>
                                ...
                                <div style="margin-top:30px;"> <a title="查看该产品的详细说明" href="http://www.ppdai.com/borrow/listtype_xz" target="_blank">查看该产品的详细说明</a></div>
                                <input class="btn font_yahei" style="margin-top:77px;" onclick="borrowRedirect('/borrow/createlist/7', '/createlist7')" value="立即申请" type="button">
                            </div>
                        </div>
                    </div>
                </div>
...
司</p>
    ...
    <script src="./ppd_borrow_files/jquery.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_borrow_files/init.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_borrow_files/servicestack-min.js"></script>
    <script src="./ppd_borrow_files/jquery_002.js"></script>
    <script src="./ppd_borrow_files/status" type="text/javascript"></script><script type="text/javascript" src="./ppd_borrow_files/acstatus.js"></script>
    ...
    <script>
        ...
        try {
            ...
            <script src="./ppd_borrow_files/validation.js"></script>
            <script src="./ppd_borrow_files/validation-zh.js"></script>
            <script type="text/javascript" src="./ppd_borrow_files/customize.js"></script>
            <script type="text/javascript">
...
<script src="./ppd_borrow_files/wpa.php" type="text/javascript" charset="utf-8"></script>
