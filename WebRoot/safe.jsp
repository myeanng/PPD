...
<link href="./ppd_safe_files/basic.css" rel="stylesheet" type="text/css">
<link href="./ppd_safe_files/layout.css" rel="stylesheet" type="text/css">

    <link href="./ppd_safe_files/account.css" rel="stylesheet" type="text/css">

<script src="./ppd_safe_files/v.htm" charset="utf-8"></script><script src="./ppd_safe_files/hm.js"></script><script src="./ppd_safe_files/analytics.js" async=""></script><script src="./ppd_safe_files/jquery.js" type="text/javascript"></script><script src="./ppd_safe_files/ppd_pop.js" type="text/javascript"></script><script src="./ppd_safe_files/hubs" type="text/javascript"></script><script src="./ppd_safe_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner clearfix w1000center">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="./ppd_safe_files/logo.png" alt="ppdai logo">
                </a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
            ...
            <div class="my-f-r-safty">
                    ...
                    <ul class="my-f-r-sflist">
                        ...
                        <li class="clearfix">
                            ...
                            <a href="http://ac.ppdai.com/userbind/bindmobile" target="_blank" class="c39a1ea fr">修改</a>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <a href="http://ac.ppdai.com/user/accountbind" target="_blank" class="c39a1ea fr">管理</a>
                        </li>
                        <li class="clearfix">
                            <p class="icons icon5-gy fl"><span class="fw">安全问题</span><span>作为基础安全工具，验证账户信息，保障账户安全。</span></p>
                            <a href="http://ac.ppdai.com/userbind/setsafequestion" target="_blank" class="c39a1ea fr">立即设置</a>
                        </li>
                        <li class="clearfix">
                            <p class="icons icon6-gy fl"><span class="fw">邮箱绑定</span><span>享受拍拍贷邮箱服务，接收账单信息，保障账号安全。</span></p>
                            <a href="http://ac.ppdai.com/userbind/bindemail" target="_blank" class="c39a1ea fr">立即绑定</a>
                        </li>
                        <li class="btnone clearfix">
                            <p class="icons icon7 fl"><span class="fw">登录密码</span><span>定期更换密码让您的账户更安全。</span></p>
                            <a href="http://ac.ppdai.com/user/updatepassword" target="_blank" class="c39a1ea fr">修改</a>
                        </li>
                        <li class="btnone clearfix">
                            <p class="icons icon8 fl"><span class="fw">登录历史</span><span>查看最近您一个月的登录历史。</span></p> 
                            <a href="http://ac.ppdai.com/safe/userloginlog" target="_blank" class="c39a1ea fr">查看</a>
                        </li>
                    </ul>
...
<!--底部结束-->
    ...
    <script src="./ppd_safe_files/gtm.js" async=""></script><script src="./ppd_safe_files/jquery_002.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_safe_files/status" type="text/javascript" charset="utf-8"></script><script type="text/javascript" src="./ppd_safe_files/acstatus.js"></script>
    <script src="./ppd_safe_files/init.js" type="text/javascript" charset="utf-8"></script>
...
<!-- End Google Tag Manager -->
    ...
    </script><script src="./ppd_safe_files/h.js" type="text/javascript"></script><div id="ac_quickLogin_pop"></div>
...
<script src="./ppd_safe_files/wpa.php" type="text/javascript" charset="utf-8"></script>
</div></body></html>