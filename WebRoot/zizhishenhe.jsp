...
<html>
  <head>
    ...
    <script src="./ppd_audit_files/a_002" async="" charset="utf-8" type="text/javascript"></script><script src="./ppd_audit_files/a_003" async="" charset="utf-8" type="text/javascript"></script><script src="./ppd_audit_files/a" async="" charset="utf-8" type="text/javascript"></script><script src="./ppd_audit_files/crmqq.php" async="" charset="utf-8" type="text/javascript"></script><script src="./ppd_audit_files/contains.js" async="" charset="utf-8" type="text/javascript"></script><script src="./ppd_audit_files/localStorage.js" async="" charset="utf-8" type="text/javascript"></script><script src="./ppd_audit_files/Panel.js" async="" charset="utf-8" type="text/javascript"></script>
            ...
            <div class="basic_infor clearfix">
               ...
               <iframe src="./ppd_audit_files/miniuserbind2014.htm" border="0" style="margin-top:5px;width:100%;" frameborder="no"></iframe>
                ...
                <div class="audit_info">
                    ...
                    <form class="clearfix" id="my_contactway" <c:if test="${linkman!=null}">style="display:none;"</c:if>>
                        <ul class="audit_L">
                            <li class="clearfix"><em>直系联系人姓名：</em><input id="secondRealName" name="onelinkman" class="txt01" style="width: 154px;" type="text"></li>
                            <li class="clearfix"><em>直系联系人手机：</em><input id="secondPhone" maxlength="11" name="onephone" class="txt01" style="width: 154px;" type="text"></li>
                            <li class="clearfix"><em>其他联系人姓名：</em><input id="thirdRealName" name="twolinkman" class="txt01" style="width: 154px;" type="text"></li>
                            <li class="clearfix"><em>其他联系人手机：</em><input id="thirdPhone" maxlength="11" name="twophone" class="txt01" style="width: 154px;" type="text"></li>
                        </ul>
                        <ul class="audit_R">
                            <li class="clearfix"><em>关系：</em>
                                <select data-validation-engine="validate[required]" class="selct" id="secondRelationships" name="onerelation"><option selected="selected" value="">--请选择--</option>
                            ...
                            <li class="clearfix"><em>关系：</em>
                                ...
                                <select data-validation-engine="validate[required]" class="selct" id="thirdRelationships" name="tworelation"><option selected="selected" value="">--请选择--</option>
											<option value="配偶">配偶</option>
											<option value="父母">父母</option>
											<option value="兄弟姐妹">兄弟姐妹</option>
											<option value="其他亲戚">其他亲戚</option>
                    ...
                    <iframe id="tishi" src="./ppd_audit_files/linkmanbind.htm" border="0" style="margin-top:5px;width:100%;<c:if test="${linkman==null}">display:none;</c:if>" frameborder="no"></iframe>
                        ...
                        <table class="data_info" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tbody><tr>
                                    ...
                                    <td><a class="blue" href="http://www.ppdai.com/viewfile/1">(${materialSize})张</a></td>
                                    <td><c:if test="${material!=null}"><fmt:formatDate value="${material.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/></c:if></td>
                                    <td>无</td>
                                    
                                    <td class="noline"> <a id="shangchuan" class="linkbutton" frontdocumentid="1" description="资料要求:1、上传本人二代身份证正反面照片及本人与身份证合照，图片文字需清晰可见。图片尺寸需要小于10M。身份证上的所有信息清晰可见，必须能看清证件号。照片需免冠，建议未化妆，手持证件人的五官清晰可见。照片内容真实有效，不得做任何修改。2、资料请由照相机或高清手机拍摄，并将照片原图上传。请勿将照片剪切或修改，请勿上传复印件或扫描件。" filetype="*.jpg;*.jpeg;*.gif;*.png;*.giff" comment="" href="javascript:void(0);">上传资料</a><a class="phoneico" id="a_download" href="javascript:;">手机</a></td>
						...
						<c:if test="${materialSize==3}">
						<iframe id="tishi" src="./ppd_audit_files/materialbind.htm" border="0" style="margin-top:5px;width:100%;" frameborder="no" <c:if test="${linkman==null}">style="display:none;"</c:if>></iframe>
						</c:if>
...
司</p>
    ...
    /**           $(".linkbutton").newWindow({
            ...
            function ResetUploadDiv() {
				...
				html.push('<form><input type="file" /><input type="submit" value="上传"></form>')
                html.push('</div>');
                return html.join("");
            }
   ...
   /**             var data = {
                ...
                $.post("linkman/addlinkman", 
                	   { "onelinkman" : $("#secondRealName").val(),
                	   	 "onerelation" : $("#secondRelationships").val(),
                	   	 "onephone" : $("#secondPhone").val(),
                	   	 "twolinkman" : $("#thirdRealName").val(),
                	   	 "tworelation" : $("#thirdRelationships").val(),
                	   	 "twophone": $("#thirdPhone").val()
                	   	 },
																	   function(data){
																	   if(data){
																	   		$("#a_contact").attr("disabled", false);
                        												 	$("#a_contact").text("保存");
                        												 	$("#my_contactway").css("display","none");
...
<div id="div2">
<form action="material/uploadMaterial" enctype="multipart/form-data" method="post">
<c:forEach begin="1" end="${3-materialSize}" step="1" >
照片:<input type="file" name="files"><br><br>
</c:forEach>
...
$("#shangchuan").click(function (){
	$("#zhezhao").css("width",document.documentElement.scrollWidth+"px");
	$("#zhezhao").css("height",document.documentElement.scrollHeight+"px");
	$("#zhezhao").css("display","block");
	$("#tanchu").css("display","block");
});
//弹出层右上角的×号实现遮罩层的隐藏
$("#tanchu #div1 span").click(function(){
