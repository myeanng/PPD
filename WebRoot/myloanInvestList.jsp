...
<html>
  <head>
    ...
    <title>正在还款的列表 - 中国首家创新民间借贷网络平台，解决个人小额贷款、短期贷款问题。个人可以通过贷款获得比银行更高的投资收益</title>
    ...
    <link rel="stylesheet" type="text/css" href="./ppd_myloan_files/basic.css">
    <link rel="stylesheet" type="text/css" href="./ppd_myloan_files/layout.css">
    <link href="./ppd_myloan_files/validation-min.css" rel="stylesheet">
    <link rel="shortcut icon" href="http://www.ppdaicdn.com/favicon.ico" type="image/x-icon">
    <script src="./ppd_myloan_files/v.htm" charset="utf-8"></script><script src="./ppd_myloan_files/hm.js"></script><script src="./ppd_myloan_files/analytics.js" async=""></script><script src="./ppd_myloan_files/gtm.js" async=""></script><script src="./ppd_myloan_files/newRefer.js"></script>
    ...
    </script><script src="./ppd_myloan_files/h.js" type="text/javascript"></script>
    
    <link rel="stylesheet" href="./ppd_myloan_files/account.css">
    

<script src="./ppd_myloan_files/jquery_003.js" type="text/javascript"></script><script src="./ppd_myloan_files/ppd_pop.js" type="text/javascript"></script><script src="./ppd_myloan_files/hubs" type="text/javascript"></script><script src="./ppd_myloan_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner w1000center clearfix">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="./ppd_myloan_files/logo.png" alt=""></a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
...
<div class="wrapleftnav fl" style="width: 200px">
    <div class="my-f-left fl">
        ...
        <ul class="my-f-l-list">
            ...
            <ul class="my-f-l-list">
                <li><a href="myAccount-myloan" class="on">我的借款</a></li>
        ...
        <div class="my-f-right fr">
            <div class="lendtotal_nav " style="margin-top: 0;">
                ...
                <div class="w528 clearfix">
                    <dl>
                        <dt>借款总额：</dt>
                        <dd><em>¥</em>${loan.loanmoney}</dd>
                    </dl>
                    <dl>
                        <dt>年利率：</dt>
                        <dd>${loan.rate*100}<em>%</em></dd>
                    </dl>
                    <dl class="nodbr">
                        <dt>期限：</dt>
                        
                            <dd>${loan.loantime} <em>个月</em></dd>
                    </dl>
                </div>
                    ...
                    <div class="my-f-r-ppb clearfix">还款计划详情</div>
                   <table cellpadding="0" cellspacing="0" class="bidhisab c666666 mt10">
                    <tr>
                        ...
                        <th>还款本金</th>
                        <th>还款利息</th>
                        <th width="180">应还款日期</th>
                        <th>操作</th>
                    </tr>
                      	<c:forEach items="${repaymentplans}" var="r">
                       <tr>
	                        <td>${r.period}</td>
	                        <td>${r.rate}%</td>
	                        <td>¥ ${r.principal}</td>
	                        <td>¥ ${r.interest}</td>
	                        <td><fmt:formatDate value="${r.shouldtime}" pattern="yyyy-MM-dd hh:mm"/></td>
	                        <td>
	                        
	                       
	                        <c:if test="${hkMap[r.period]!=null}">
	                        	已还
	                        </c:if>
	                        <c:if test="${hkMap[r.period]==null}">
	                        	<a href="myAccount-hk?loanid=${loan.loanid}&period=${r.period}">去还款</a>
	                        </c:if>
                   ...
                   <div class="my-f-r-ppb clearfix">项目投资 详情</div>
                    <table cellpadding="0" cellspacing="0" class="bidhisab c666666 mt10">
                    <tr>
                        ...
                        <th>有效金额</th>
                        <th>当年利率</th>
                        <th width="180">投标时间</th>
                    </tr>
                      	<c:forEach items="${investrecords}" var="i">
                       <tr>
	                        <td>${i.users.username}</td>
	                        <td>¥ ${i.money}</td>
	                        <td>${i.rate}%</td>
	                        <td><fmt:formatDate value="${i.investtime}" pattern="yyyy-MM-dd hh:mm"/></td>
                       </tr>
                       </c:forEach>
                </table>
...
司</p>
    ...
    <script src="./ppd_myloan_files/jquery.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_myloan_files/init.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_myloan_files/servicestack-min.js"></script>
    <script src="./ppd_myloan_files/jquery_002.js"></script>
    <script src="./ppd_myloan_files/status" type="text/javascript"></script><script type="text/javascript" src="./ppd_myloan_files/acstatus.js"></script>
...
<script src="./ppd_myloan_files/wpa.php" type="text/javascript" charset="utf-8"></script>
