...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./ppd_howtolend_files/basic.css">
    <link rel="stylesheet" type="text/css" href="./ppd_howtolend_files/layout.css">
    <link href="./ppd_howtolend_files/validation-min.css" rel="stylesheet">
    <link rel="shortcut icon" href="http://www.ppdaicdn.com/favicon.ico" type="image/x-icon">
    <script src="./ppd_howtolend_files/v.htm" charset="utf-8"></script><script src="./ppd_howtolend_files/hm.js"></script><script src="./ppd_howtolend_files/analytics.js" async=""></script><script src="./ppd_howtolend_files/gtm.js" async=""></script><script src="./ppd_howtolend_files/newRefer.js"></script>
    ...
    </script><script src="./ppd_howtolend_files/h.js" type="text/javascript"></script>
    
<script src="./ppd_howtolend_files/jquery_003.js" type="text/javascript"></script><script src="./ppd_howtolend_files/ppd_pop.js" type="text/javascript"></script><script src="./ppd_howtolend_files/hubs" type="text/javascript"></script><script src="./ppd_howtolend_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner w1000center clearfix">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="./ppd_howtolend_files/logo.png" alt=""></a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
...
<link rel="stylesheet" type="text/css" href="./ppd_howtolend_files/basic_002.css">
<link rel="stylesheet" type="text/css" href="./ppd_howtolend_files/layout_002.css">
<link rel="stylesheet" type="text/css" href="./ppd_howtolend_files/staticPage.css">
<link rel="stylesheet" type="text/css" href="./ppd_howtolend_files/about.css">
<style>
    .center1000 {
        width: 1000px;
        margin: 0 auto;
...
<div id="content_nav" class="row show-grid center980 l_content">
        ...
        <ul class="breadcrumb" style="border: none !important;">
                        ...
                        <li><a href="http://www.ppdai.com/lend">我要借出</a> <span class="divider">&gt;</span></li>
                            <li class="active">如何借出</li>
    ...
    <div id="content_nav" class="main">
        ...
        <div class="l_banner">
            <div class="l_bann1">
                <img src="./ppd_howtolend_files/l_banner01.jpg"></div>
        </div>
        <!--banner图开结束-->
        <!--借出内容开始-->
        <div class="l_content">
            <div class="l_con01">
                <div class="l_contit">怎样在拍拍贷理财?</div>
            </div>
            <div class="l_conlimg1 clearfix">
                <div class="l_conlimg2">
                    <img src="./ppd_howtolend_files/l_imglc.gif">
                </div>
                <div class="l_conlmg3">
                    
                    <a title="立刻体验投标" href="http://www.ppdai.com/lend?howlend">我要投资</a>
                </div>
            </div>
            <div class="l_conimg4">
                <img src="./ppd_howtolend_files/l_lengimg04.gif"></div>
            <div class="l_con01">
                <div class="l_contit2">如何投标?</div>
                <div class="l_conlfun">
                    <div class="l_conat"><a href="http://www.ppdai.com/autobid/addrule">立即体验&gt;&gt;</a></div>
                    <div class="l_consd"><a href="http://www.ppdai.com/lend?howlend">立即体验&gt;&gt;</a></div>
                </div>
...
<script type="text/javascript" src="./ppd_howtolend_files/conversion.js">
</script><iframe name="google_conversion_frame" title="Google conversion frame" src="./ppd_howtolend_files/a.htm" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" frameborder="0" height="13" width="300">&lt;img
 height="1" width="1" border="0" alt="" 
src="http://googleads.g.doubleclick.net/pagead/viewthroughconversion/1059133371/?frame=0&amp;random=1426679208471&amp;cv=7&amp;fst=1426679208471&amp;num=1&amp;fmt=1&amp;label=0QLkCOGX8gEQu6-E-QM&amp;guid=ON&amp;u_h=768&amp;u_w=1366&amp;u_ah=738&amp;u_aw=1366&amp;u_cd=24&amp;u_his=17&amp;u_tz=480&amp;u_java=false&amp;u_nplug=27&amp;u_nmime=40&amp;frm=0&amp;url=http%3A//www.ppdai.com/howtolend&amp;ref=http%3A//invest.ppdai.com/product/info%3Fproducttype%3Dppb%26months%3D6%26productid%3D306&amp;vis=1"
 /&gt;</iframe>
<noscript>
...
司</p>
    ...
    <script src="./ppd_howtolend_files/jquery.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_howtolend_files/init.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_howtolend_files/servicestack-min.js"></script>
    <script src="./ppd_howtolend_files/jquery_002.js"></script>
    <script src="./ppd_howtolend_files/status" type="text/javascript"></script><script type="text/javascript" src="./ppd_howtolend_files/acstatus.js"></script>
...
<script src="./ppd_howtolend_files/wpa.php" type="text/javascript" charset="utf-8"></script>
</div></body></html>