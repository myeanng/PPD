...
<html>
  <head>
    ...
    <title>视频认证 拍拍贷-中国首家，最大、最多人使用的互联网金融P2P网络借贷平台。提供小额贷款,短期贷款,个人贷款,自定利率,借期灵活。您还可以成为借出人理财投资,超低门槛，获得高年收益率回报</title>
    ...
    <link rel="stylesheet" type="text/css" href="./ppd_auth_files/basic.css">
    <link rel="stylesheet" type="text/css" href="./ppd_auth_files/layout.css">
    <link href="./ppd_auth_files/validation-min.css" rel="stylesheet">
    <link rel="shortcut icon" href="http://www.ppdaicdn.com/favicon.ico" type="image/x-icon">
    <script src="./ppd_auth_files/v.htm" charset="utf-8"></script><script src="./ppd_auth_files/hm.js"></script><script src="./ppd_auth_files/analytics.js" async=""></script><script src="./ppd_auth_files/gtm.js" async=""></script><script src="./ppd_auth_files/newRefer.js"></script>
    ...
    </script><script src="./ppd_auth_files/h.js" type="text/javascript"></script>
    
    <link rel="stylesheet" href="./ppd_auth_files/account.css">
    <link rel="stylesheet" type="text/css" href="./ppd_auth_files/authentication.css">

<script src="./ppd_auth_files/jquery_003.js" type="text/javascript"></script><script src="./ppd_auth_files/ppd_pop.js" type="text/javascript"></script><script src="./ppd_auth_files/hubs" type="text/javascript"></script><script src="./ppd_auth_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner w1000center clearfix">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="./ppd_auth_files/logo.png" alt=""></a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
    ...
    <ul class="breadcrumb" style="border: none !important;">
        <li><a href="http://www.ppdai.com/">首页</a> <span class="divider">&gt;</span></li>
            <li><a href="http://www.ppdai.com/account/borrow">我的账户-我是借款者</a> <span class="divider">&gt;</span></li>
                    <li><a href="http://www.ppdai.com/user/auth/videouser">信息认证-视频认证</a></li>
    </ul>
</div>
<script>
    ...
    <div class="my-f-left fl">
        ...
        <ul class="my-f-l-list">
            ...
            <ul class="my-f-l-list">
                ...
                <li><a href="http://www.ppdai.com/user/auth/videouser" class="on">信息认证</a></li>
        ...
        <ul class="my-f-l-list">
            ...
            <li><a href="http://www.ppdai.com/account/raffletickets">我的抽奖券</a></li>
                ...
                <div class="my-f-right fr">
                    <div class="my-f-r-authentication pb20">
                        <ul class="authenticationNav clearfix">
                            <li class="first w131"><a href="http://www.ppdai.com/user/auth/mobile">手机实名认证</a></li>
                            <li class="current"><a href="http://www.ppdai.com/user/auth/videouser">视频认证</a></li>
                            <li><a href="http://www.ppdai.com/user/auth/household">户口认证</a></li>
                            <li><a href="http://www.ppdai.com/user/auth/education">学历认证</a></li>
                            <li><a href="http://www.ppdai.com/user/auth/enrolment">学籍认证</a></li>
                            <li class="last"><a href="http://www.ppdai.com/user/auth/taobaouser">网商认证</a></li>
                        </ul>
                        <div class="authenticationItem">
                                <table class="authenticationItemVideo">
                                    <tbody><tr>
                                        <td>
                                            <embed src="./ppd_auth_files/loader.swf" quality="high" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" align="middle" height="304" width="335"></td>
                                        <td>
                                            <p>请按如下文字阅读</p>
                                            各位亲，我是<strong>杨振林</strong>，我在拍拍贷的用户名是 pdu11557782<br>
                                            我是一个诚信的人，<br>
                                            我了解拍拍贷的所有规则，<br>
                                            我向大家提交的所有资料都是真实的，<br>
                                            我会对自己的行为负责，<br>
                                            也会按时还款，请相信我并且支持我吧！
                                                ...
                                                <form action="http://v0.api.upyun.com/pdvideo" method="post" enctype="Multipart/form-data" id="form1">
                                                    <input value="" name="policy" type="hidden">
                                                    <input value="f3a81fb30bbbb1847acedef5eca70605" name="signature" type="hidden">
                                                    <div class="bottom"><span>上传文件：</span><input name="file" type="file"></div>
                                                    <input value="提交视频认证" class="submit" type="submit">
                                                </form>
                                        </td>
                                    </tr>
                                </tbody></table>
                    ...
                    <div class="oneRowDivFormExplain clearfix">
                        温馨提示：
			            	<ul>
                                <li>1、视频必须为本人真实场景拍摄，请您确保衣冠整洁，举止文明。图像需要清晰可辨，声音洪亮清楚；视频内不得出现直系亲属以外的他人图像</li>
                                <li>2、视频格式需为avi，mpeg，rm，rmvb，mpg，3gp，mp4， mov，mtv，wmv，amv类型，文件大小不得超过10MB。</li>
                                <li>3、资费标准：免费认证，永久有效。</li>
                            </ul>
                    </div>
                </div>
                <!--右边结束-->
...
司</p>
    ...
    <script src="./ppd_auth_files/jquery.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_auth_files/init.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_auth_files/servicestack-min.js"></script>
    <script src="./ppd_auth_files/jquery_002.js"></script>
    <script src="./ppd_auth_files/status" type="text/javascript"></script><script type="text/javascript" src="./ppd_auth_files/acstatus.js"></script>
...
<script src="./ppd_auth_files/wpa.php" type="text/javascript" charset="utf-8"></script>
