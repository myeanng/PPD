...
//		"url1":[/^((http|https):\/\/)[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]+)+(\/[^/\n]*)*$/]
	...
	var checkitemAll = {
		check0 : [
				...
				{ name:"ic",type:"idnum",message:"请输入正确的身份证号码"},
				{ name:"users.tel",type:"mobilephone",message:"请输入正确的手机号码"},
				{ name:"qq",type:"qq1",betweenString:[4,11],message:"请输入正确的QQ号"},
				{ name:"marriage",message:"请选择婚姻状况"},
				{ name:"education",message:"请选择学历"},
				{ name:"address",message:"请选择住宅地址"},
				{ name:"addresstwo",betweenString:[5,40],message:"请检查具体地址，必须在5-40个字之间"},
				{ name:"homephone",type:"residence_phone",message:"请填写住宅电话，例如021-51870819或13813888888"},
				{ name:"property",simple:"财力证明",message:""},
				{ name:"company",betweenString:[2,20],message:"请检查单位名称，必须在2-20个字之间"},
				{ name:"worktime",message:"请选择工作年限"},
				{ name:"workaddress",message:"请选择工作地址"},
				{ name:"workaddresstwo",betweenString:[5,40],message:"请检查单位详细地址，必须在5-40个字之间"},
				{ name:"companyphone",type:"residence_phone",message:"请填写单位电话，例如021-51870819或13813888888"},
				{ name:"DistrictIdForWageEarner",message:"请选择单位所在地区"},
				{ name:"department",betweenString:[2,20],message:"请检查任职部门，必须在2-20个字之间"},
				{ name:"job",betweenString:[2,20],message:"请检查任职职位，必须在2-20个字之间"}
		]
/**		check1 : [
				{ name:"realname",type:"real_name",betweenString:[2,20],message:"姓名只能输入2-20个汉字，例如：张三 或者 纳斯尔丁·阿凡提"},
    			{ name:"ic",type:"idnum",message:"请输入正确的身份证号"},
    			{ name:"users.tel",type:"mobilephone",message:"请输入正确的手机号码"},
