...
public class PagerTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {  
        ...
        if(recordCount == 0){  
            ...
            // 把当前页号设置成请求参数  
            sb.append("<input type=\"hidden\" name=\"").append("pageNumber")  
                .append("\" value=\"").append(pageNumber).append("\"/>\r\n");  
            ...
            sb.append("    document.qPagerForm.pageNumber.value=no;\r\n");  
